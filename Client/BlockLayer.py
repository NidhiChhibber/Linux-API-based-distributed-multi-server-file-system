...
class BlockLayer():
    ...
    def update_data_block(self, block_number, block_data,server_number):
        MemoryInterface.update_data_block(block_number, block_data,server_number)
    ...
    def free_data_block(self, block_number,server_number):
        MemoryInterface.free_data_block(block_number,server_number)

    def free_data_block_MFS(self, block_number):
        MemoryInterface.free_data_block_MFS(block_number)
